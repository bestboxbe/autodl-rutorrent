...
function AutodlIrssiTab(dialogManager, plugin) {
	...
	plugin.attachPageToTabs($(
		'<div class="autodl-main-layout" id="autodl-irssi-tab">' +
		'<div class="autodl-actions-footer" id="autodl-log-buttons" style="justify-content: flex-start; flex-wrap: wrap; height: auto;">' +
		...
		'<form target="autodl-restore-iframe" id="autodl-restore" method="POST" action="plugins/autodl-irssi/writeconfig.php" enctype="multipart/form-data" style="display: inline-block;">' +
		...
		'<input id="autodl-restore-file" type="file" name="file" title="' + theUILang.autodlRestore3 + '" style="width: 150px;" />' +
		'</form>' +
		'</div>' +
		'<div class="autodl-grid-content" style="flex-direction: column !important;">' +
		'<div id="autodl-irssi-log">' +
		'<table>' +
