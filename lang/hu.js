theUILang.autodlPreferences = "autodl-irssi Beállítások";
theUILang.autodlFilters = "autodl-irssi Szűrúl";
theUILang.autodlTrackers = "autodl-irssi Trackerek";
theUILang.autodlServers = "autodl-irssi Announce csatornák";
theUILang.autodlPreferences2 = "Preferences...";
theUILang.autodlFilters2 = "Szűrők...";
theUILang.autodlTrackers2 = "Trackerek...";
theUILang.autodlServers2 = "Announce csatornák";
theUILang.autodlHelp = "autodl-irssi segítég";
theUILang.autodlHelp2 = "Segítség";
theUILang.autodlGeneral = "Általános";
theUILang.autodlUploadMethod = "Művelet";
theUILang.autodlWebui = "Webui";
theUILang.autodlFtp = "FTP";
theUILang.autodlPrograms = "Program";
theUILang.autodlAdvanced = "Haladó";
theUILang.autodlMaxSavedRels = "Maximum mentett kiadások(rls)";
theUILang.autodlSaveDlHist = "Letöltési előzmények mentése";
theUILang.autodlDownloadDupes = "Duplikált kiadások(rls) letöltése";
theUILang.autodlAutomaticUpdates = "Automatikus frissítések";
theUILang.autodlUpdateAutomatically = "Automatikus frissítés";
theUILang.autodlAsk = "Ask";
theUILang.autodlDontCheckForUpdates = "Ne ellenőrizze a frissítéseket";
theUILang.autodlChooseUploadMethod = "Válassza ki a .torrent műveletet";
theUILang.autodlChoose = "Válasszon...";
theUILang.autodlChooseMethod = "Válassza ki, hogyan mentse/letöltse a torrentet fentebb...";
theUILang.autodlOverride1 = "Globális beállítások használata";
theUILang.autodlOverride2 = "Globális művelet használata (Beállítások -> Művelet)";
theUILang.autodlTestFilter = "Teszt";
theUILang.autodlSaveToWatchFolder = "Mentés a watch mappába";
theUILang.autodlUtorrentWebui = "&#x3BC;Torrent Webui Upload";
theUILang.autodlFtpUpoad = "FTP feltöltés";
theUILang.autodlRunProgram = "Program indítása";
theUILang.autodlDynamicFolder = "&#x3BC;Torrent mappa";
theUILang.autodlTorrentClientWatchFolder = "Watch mappa";
...
theUILang.autodlFtpPath = "FTP mappa";
theUILang.autodlCommand = "Parancs";
theUILang.autodlArguments = "Arguments";
theUILang.autodlFolder = "Mappa";
theUILang.autodlOnlyUtorrentWebui2 = "Only &#x3BC;Torrent webui is supported.";
theUILang.autodlUserName = "Felhasználónév";
theUILang.autodlPassword = "Jelszó";
theUILang.autodlHostname = "Hostnév";
theUILang.autodlIpAddress = "IP cím";
theUILang.autodlPort = "Port";
theUILang.autodlUseSsl = "HTTPS (SSL) használata";
...
theUILang.autodlSeconds = "másodpercek";
theUILang.autodlOutputLevel = "Output Level";
theUILang.autodlDebug = "Debug";
theUILang.autodlNew = "Új";
theUILang.autodlRemove = "Törlés";
theUILang.autodlTvMovies = "TV/Film";
theUILang.autodlMusic = "Zene";
theUILang.autodlDisplayName = "Megjelenített név";
theUILang.autodlMatchReleases = "Egyező rls csapat";
theUILang.autodlExceptReleases = "Kihagyott rls csapat";
theUILang.autodlMatchSites = "Egyező oldalak";
theUILang.autodlMinimumSize = "Minimum méret";
theUILang.autodlMaximumSize = "Maximum méret";
theUILang.autodlTvShowMovie = "TV Műsor/Film";
theUILang.autodlSeasons = "Évadok";
theUILang.autodlEpisodes = "Epizódok";
theUILang.autodlResolutions = "Felbontások";
theUILang.autodlEncoders = "Kódolók";
theUILang.autodlSources = "Források";
theUILang.autodlYears = "Évek";
theUILang.autodlWhatWafflesOnly = "Waffles és What.CD";
theUILang.autodlArtists = "Művészek";
theUILang.autodlAlbums = "Albumok";
theUILang.autodlFormats = "Formátum";
theUILang.autodlBitrates = "Bitráta";
theUILang.autodlMedia = "Média";
theUILang.autodlTags = "Címkék";
theUILang.autodlScene = "Eredeti(scene)";
theUILang.autodlDontCare = "Nem érdekel";
theUILang.autodlYes = "Igen";
theUILang.autodlNo = "Nem";
theUILang.autodlMatchCategories = "Egyező kategóriák";
theUILang.autodlExceptCategories = "Kihagyott kategóriák";
theUILang.autodlMatchUploaders = "Egyező feltöltők";
theUILang.autodlExceptUploaders = "Kihagyott feltöltők";
theUILang.autodlExceptSites = "Kihagyott oldalak";
...
theUILang.autodlUploadDelay = "Késleltetés";
...
theUILang.autodlTitle30 = "Name of folder, macros are allowed, Pl: C:\\downloads\\$(month)$(day)\\$(TrackerShort)";
...
theUILang.autodlClose = "Bezárás";
theUILang.autodlHint1 = "Name your filter";
theUILang.autodlHint2 = "Releases you want, Pl: Lost*,The?Simpsons*";
theUILang.autodlHint3 = "Releases you don't want";
theUILang.autodlHint4 = "List of sites";
theUILang.autodlHint5 = "Minimum size Pl: 500MB";
theUILang.autodlHint6 = "Maximum size Pl: 2.5GB";
theUILang.autodlHint7 = "TV show or movie, Pl: The Simpsons, Lost";
theUILang.autodlHint8 = "Pl: 6-9,11";
theUILang.autodlHint9 = "Pl: 1-7,11,13,19-25";
theUILang.autodlHint10 = "Resolution, Pl: 720p, 1080p";
theUILang.autodlHint11 = "Encoder, Pl: x264, xvid";
theUILang.autodlHint12 = "Source, Pl: HDTV, DSR";
theUILang.autodlHint13 = "Years, Pl: 1999,2005-2007";
theUILang.autodlHint14 = "Artists, Pl: Artist1,*artist*";
theUILang.autodlHint15 = "Albums, Pl: Album1,*album*";
theUILang.autodlHint16 = "Formats, Pl: MP3,FLAC";
theUILang.autodlHint17 = "Bitrates, Pl: 320,V0*,*Lossless";
theUILang.autodlHint18 = "Media, Pl: CD,WEB";
...
theUILang.autodlHint24 = "Maximum pretime Pl: 10min 3s";
theUILang.autodlHint25 = "Tags, Pl: hip hop, rock";
theUILang.autodlHint27 = "FTP path, Pl: /home/YOURNAME/watchdir";
theUILang.autodlHint28 = "Command Pl: ~/myscript";
theUILang.autodlHint29 = "Program arguments";
theUILang.autodlHint30 = "Pl: C:\\downloads\\$(month)$(day)";
theUILang.autodlHint31 = "Path to utorrent.exe";
theUILang.autodlHint32 = "Leave blank for default";
theUILang.autodlError = "Error downloading files. Make sure autodl-irssi is started and configured properly (Pl: password, port number): ";
...
theUILang.autodlUpdate1 = "Frissítés";
theUILang.autodlUpdate2 = "Autodl-irssi frissítése";
theUILang.autodlWhatsNew1 = "Újdonságok";
theUILang.autodlWhatsNew2 = "Mutasd meg az újdonságokat a frissítés előtt";
theUILang.autodlVersion1 = "Verzió";
theUILang.autodlVersion2 = "Jelenlegi verzióinformáció megjelenítése";
theUILang.autodlReload1 = "Újratöltés";
theUILang.autodlReload2 = "Autodl-irssi újratöltése";
theUILang.autodlReloadTrackers1 = "Trackerek újratöltése";
theUILang.autodlReloadTrackers2 = "Tracker fájlok újratöltése";
theUILang.autodlBackup1 = "Biztonsági mentés";
theUILang.autodlBackup2 = "Biztonsági mentés az autodl-irssi beállításairól";
theUILang.autodlRestore1 = "Visszaállítás";
theUILang.autodlRestore2 = "Az autodl-irssi beállítások visszaállítása";
theUILang.autodlRestore3 = "Válassza ki a biztonsági mentési fájlt";
theUILang.autodlMissingFilename = "Először ki kell választania egy fájlt!";
theUILang.autodlIrcServers = "autodl-irssi IRC Servers";
theUILang.autodlIrcServers2 = "IRC Sezrverek...";
theUILang.autodlIrcsrvs1 = "IRC Sezrver";
theUILang.autodlIrcsrvs2 = "Szerver";
theUILang.autodlIrcsrvs3 = "The IRC server, Pl: irc.server.org";
theUILang.autodlIrcsrvs4 = "Pl: irc.server.org";
theUILang.autodlIrcsrvs5 = "Port";
theUILang.autodlIrcsrvs6 = "IRC server port. Default is 6667 or 6697 (SSL)";
theUILang.autodlIrcsrvs7 = "Pl: 6667";
...
theUILang.autodlIrcsrvs19 = "The name of the channel, Pl: #channel";
theUILang.autodlIrcsrvs20 = "Pl: #channel";
...
theUILang.autodlIrcsrvs25 = "Pl: /msg SomeOne mypassword";
...
theUILang.autodlWolDesc = "You can send a Wake on LAN magic packet to wake up the destination computer. The packet is sent before uploading the torrent using &#x3BC;Torrent webui or FTP. You need to tell the router to forward UDP port 9 to the router's broadcast address, Pl: 192.168.0.255";
theUILang.autodlWolMac = "MAC cím";
theUILang.autodlWolMacTitle = "A számítógép MAC-címe";
theUILang.autodlWolMacEmpty = "Pl: 00:11:22:33:44:55";
theUILang.autodlWolIp = "IP cím";
theUILang.autodlWolIpTitle = "The public IP address of your router. Default is destination IP address.";
theUILang.autodlWolIpEmpty = "Pl: 123.45.67.89";
...
theUILang.autodlWolPortEmpty = "Pl: 9";
theUILang.autodlIrcOutputDesc = "Send all autodl-irssi output to the following IRC channel";
theUILang.autodlOutputServer = "Szerver";
theUILang.autodlOutputServerTitle = "Az IRC szerver";
theUILang.autodlOutputServerEmpty = "Pl: irc.server.org";
theUILang.autodlOutputChannel = "Csatorna";
theUILang.autodlOutputChannelTitle = "A csatorna";
theUILang.autodlOutputChannelEmpty = "Pl: #channel";
...
theUILang.autodlTitle49 = "Destination directory. You can use macros, Pl: ~/downloads/$(Month)$(Day)";
...
theUILang.autodlLabel = "Címke";
theUILang.autodlTitle51 = "The ruTorrent label. You can use macros, Pl: $(Tracker)";
...
theUILang.autodlNone = "Nincs";
theUILang.autodlPrioHigh = "Magas";
theUILang.autodlPrioNormal = "Normál";
theUILang.autodlPrioLow = "Alacsony";
theUILang.autodlPrioDontDownload = "Don't DL";
theUILang.autodlRtDestDir = "Mappa";
...
theUILang.autodlAny = "Bármelyik";
theUILang.autodlAll = "Összes";
...
theUILang.autodlHint36 = "Containers Pl: mkv, mp4";
...
theUILang.autodlFiltersUseRegex = "Regex használata";
...
theUILang.autodlHint37 = "Release types Pl: Album, EP";
...
theUILang.autodlHint38 = "Release groups Pl: HiFi, decibeL";
