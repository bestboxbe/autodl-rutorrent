...
plugin.__init =
	function () {
		...
		// Modernized CSS loading
		// We no longer guess themes or load non-existent files.
		// The new autodl.css uses CSS variables to adapt to the global rutorrent theme.
		this.loadCSS("css/autodl");
